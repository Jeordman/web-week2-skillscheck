...
// Create an object called 'me' that has these keys with the correct values: firstName, state, age, 
//greeter. firstName will be your name as a string. state will be your current state 
//or providence as a string. age will be your age as a number. 
//greeter will be a method that returns the string 
...
//that takes in one parameter, arr. Inside of arrayReverser, create an empty array called 
//'reversed'. Using a for loop, loop over the passed in array in reverse and add each item to 
//the new reversed array. Finally, return the new reversed array
...
// Code Here
const doubled = myNumbers.map((item) => {
	return item * 2
})
...
// Code Here
const total = myNumbers.reduce((prev, curr) => {
	return prev += curr
})
...
//First, create an empty array called myNumbersIndex. Next, using forEach, push each items 
//index from the myNumbers array to the myNumbersIndex array
...
// Code Here
const forTheLoveOfGeorge = notGeorge.map((item) => {
	return item = 'George'
})
//////////////////PROBLEM 19////////////////////
