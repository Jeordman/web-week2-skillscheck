...
// CODE HERE
const faveColors = ['aqua', 'black', 'blue']
...
let me = {
    firstName: 'Jeordin',
    superHeroName: 'w33dg0d',
    homeTown: 'West Valley',
    superPowers: ['crying', 'weeping', 'pondering'],
...
//If any of the colors you chose is 'blue', change 
//it's value to '#4D4DFF' which is just a more appealing color of blue. 
...
//These arguments should be each item of your array. This is a function we created for you to 
...
//Loop over the arr param and run a function called createLi(), which will take each item 
//of the array as an argument. The createLi function is a function we created to set the 
